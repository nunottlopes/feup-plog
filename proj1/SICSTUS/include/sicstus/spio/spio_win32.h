...
#define SPIO_SID_NAME_OPTION_SID_STRING_FALLBACK SPIO_NEXT_BIT(SPIO_SID_NAME_OPTION_SID_STRING) /* fall back to S- sting SID */
...
extern spio_t_error_code spio_win32_get_environ(char ***penv, size_t *psize, spio_t_bits options);
