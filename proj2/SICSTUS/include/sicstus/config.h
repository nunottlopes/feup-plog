...
#define SICSTUS_MINOR_VERSION 4
...
/* [PD] 3.11.1 */
#define SICSTUS_VERSION_STRING "4.4.1"
...
#define SP_GET_DISPATCH_NAME SP_get_dispatch_40401
...
#define SP_OS_DATA_PLATFORM_NAME_STRING "darwin"
#define SP_JIT_ABI_STRING "darwinx64"
...
#define JIT_FLI 1
/* [PM] 4.3.4 Whether kernel routines should use external linkage. The
   default (since SPRM 15042) is to use local labels resolved via
   kerntab_offsets[]. */
#define JIT_KERNEL_EXTERNALS 0
...
#define SP_RTSYS_DIRNAME "sp-4.4.1"
#define SP_EMULATOR_DIRNAME "sicstus-4.4.1"
/* [PM] 3.11.0 */
#define LICENSE_PRODUCT "sicstus4.4_darwin"
...
#define SP_MACOSX_FROM_OS_WCX_FILE_IS_NFC 1
...
/* System information */
#define SYSTEM_NAME "x86_64-darwin-17.2.0"
...
#define RTKERNEL_BASENAME_SANS_SUFFIX_STRING "libsprt4-4-1"
#define RTKERNEL_BASENAME_WITH_DSO_SUFFIX_STRING "libsprt4-4-1.dylib"
...
/* Something like "libsprt-4-1-2-instance-XX.so". Must contain exactly
   ...
   literal string) */
#define RTKERNEL_INSTANCE_TEMPLATE_STRING "libsprt4-4-1-instance-XX"
...
*/
#define SP_POLL_BROKEN_FOR_DEVICES 2
